...
jqueryWidget: {
    _init: function () {
        var opts = {
            ...
            triggers:    [1],
            children:    [this.options._dashed ? "DashedSentenceBis" : "FlashSentence",
                          ...
                          this.options._dashed ? "!QuestionBis" : "QuestionBis",
                          { q:                   this.options.q,
                            as:                  this.options.as,
...
properties: {
    ...
    htmlDescription:
        function (opts) {
            var s = ibex_controller_get_property("DashedSentenceBis", "htmlDescription")(opts);
            var q = ibex_controller_get_property("QuestionBis", "htmlDescription")(opts);
            var p =
                $("<p>")
